...
def main():
        ...
        # prepare l'input per clf
        dataset_X = []
        dataset_y = []
        for i in range(0, len(dataset)):
                dataset_X.append(dataset[i][0:-1])
        ...
        for i in range(len(dataset_X)):
                dataset_X_entry = dataset_X[i]
                pred_y = clf.predict([dataset_X_entry])[0]
                if(dataset_y[i] == pred_y):
                        if pred_y == '1':
        ...
        print('accuracy', str(truePositive + trueNegative) + '/' + str(len(dataset_X)), str(float(truePositive + trueNegative) / len(dataset_X)) + '%')
